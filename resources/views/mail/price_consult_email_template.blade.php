            ...
            <tr>
                <td align="center">
                    <table class="content" width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="center"><h6 style="color:#94bb1e">Portal do Cliente</h6></td>
                        </tr>
                                ...
                                <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td class="content-cell">
                                            <h3>Olá, {{ $data['vendedor'] }}</h3>
                                            <p>Sou o Cliente {{ $data['client'] }} ( {{ $data['client_id'] }} ) com o email {{ $data['client_email'] }}.</p>
                                            <p>Eu gostaria de solicitar a cotação do seguinte produto: {{ $data['produto_name'] }} ( {{ $data['produto_codigo'] }} ).</p>
