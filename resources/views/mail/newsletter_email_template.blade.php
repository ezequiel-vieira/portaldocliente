                        ...
                        <tr>
                            <td class="body" width="100%" cellpadding="0" cellspacing="0">
                                <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td class="content-cell">
                                            Estamos enviando este e-mail de forma a dar-lhe a conhecer os nossos últimos produtos.
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                        ...
                                        <tr>
                                            <td class="content-cell" valign="top" width="400" height="400" background="{{ $produto->name }}">
                                                <div style="text-align: center">
                                                    <img src="{{ 'http://portaldocliente.gruponobrega.pt'.$produto->url }}" title="{{ $produto->name }}" width="400" height="400">
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
