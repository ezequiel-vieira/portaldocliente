                        ...
                        <tr>
                            <td align="center">
                                @if(isset($data['id_sap']))
                                    <h6 style="color:#94bb1e">Portal do Cliente | Grupo Nóbrega</h6>
                                @else
                                    <h6 style="color:#94bb1e">Portal do Cliente | Madeira Cash</h6>                                           
                                @endif
                            </td>
                        </tr>
                        <!-- Email Body -->
                                ...
                                <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td class="content-cell">
                                            @if(isset($data['id_sap']))
                                                <h3 style="color:#5cb85c">CLIENTE REGISTADO</h3>
                                                <hr>
                                            @else
                                                <h3 style="color:#d9534f">CLIENTE NÃO REGISTADO</h3>
                                                <hr>                                           
                                            @endif
                                            <h3>Olá</h3>
