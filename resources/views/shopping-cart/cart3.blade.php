...
@section('content')
    <form class="form-encomenda wrapper-wide form-horizontal was-validated" method="POST" action="{{ url('/cliente/encomenda3/') }}">
        {{csrf_field()}}
        <div class="container">
            <div class="row">
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        ...
        $("#concelhoFormControlSelect").change(function () 
        {
            ...
            if (concelho === 'machico' || concelho === 'santana' || concelho === 'camara_lobos' || concelho === 'ribeira_brava') 
            {
